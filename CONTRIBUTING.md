...
Contributions to **FlorianWolters\Application\UrlShortener-Silex** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Application\UrlShortener-Silex**:

    md UrlShortener-Silex && cd UrlShortener-Silex
    git clone git://github.com/FlorianWolters/PHP-Application-UrlShortener-Silex.git
